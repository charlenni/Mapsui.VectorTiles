                ...
                { // the simple selector tree exists.
                        ...
                        selectorIdx++)
                    {
                        ...
                        { // parse attribute selectors.
                            ...
                            {
                                // the truthy selector. Could be true, yes or 1
                                if (attributeSelector.ChildCount < 2)
                                {
                                    // oeps, this is not possible.
                                    throw new MapCSSDomainParserException(attributeSelector,
                                ...
                                string[] values = new string[] { "true", "yes", "1" };
                                ...
                                for (int i = 0; i < 3; i++)
                                {
                                    ...
                                    selectorRuleTagValueComparison.Value = values[i];
                                ...
                                attributeSelector.Children[0].Text == "!=")
                            {
                                ...
                                switch (attributeSelector.Children[0].Text)
                                {
                                    ...
                                    case "<":
                                        selectorRuleTagValueComparison.Comparator =
                                            SelectorRuleTagValueComparison.SelectorRuleTagValueComparisonEnum.SmallerThan;
                                        break;
                                    case ">=":
                                        selectorRuleTagValueComparison.Comparator =
                                            SelectorRuleTagValueComparison.SelectorRuleTagValueComparisonEnum.GreaterThanOrEqual;
                                        break;
                                    case "<=":
                                        selectorRuleTagValueComparison.Comparator =
                                            SelectorRuleTagValueComparison.SelectorRuleTagValueComparisonEnum.SmallerThanOrEqual;
                                        break;
                                    case "=":
                                        selectorRuleTagValueComparison.Comparator =
                                            SelectorRuleTagValueComparison.SelectorRuleTagValueComparisonEnum.Equal;
...
//                    string[] strings;
                    ...
                    switch (qualifierString)
                    {
                        ...
                        case "text-anchor-vertical":
                            var textAnchorVertical = new DeclarationTextAnchorVertical();
                            textAnchorVertical.Qualifier = DeclarationTextAnchorVerticalEnum.TextAnchorVertical;
                            if (evalCall != null)
                            {
                            ...
                            else
                            {
                                ...
                                {
                                    case "bottom":
                                        textAnchorVertical.Value = TextAnchorVerticalEnum.Bottom;
                                        break;
                                    case "above":
                                        textAnchorVertical.Value = TextAnchorVerticalEnum.Above;
                                        break;
                                    case "top":
                                        textAnchorVertical.Value = TextAnchorVerticalEnum.Top;
                                        break;
                                    case "center":
                                        textAnchorVertical.Value = TextAnchorVerticalEnum.Center;
                                        break;
                                    case "below":
                                        textAnchorVertical.Value = TextAnchorVerticalEnum.Below;
                                        break;
                                    default:
                                        throw new MapCSSDomainParserException(declarationTree,
                                            string.Format("{1} value {0} cannot be parsed!", valueString, qualifierString));
                        ...
                        case "text-anchor-horizontal":
                            var textAnchorHorizontal = new DeclarationTextAnchorHorizontal();
                            textAnchorHorizontal.Qualifier = DeclarationTextAnchorHorizontalEnum.TextAnchorHorizontal;
                            if (evalCall != null)
                            {
                            ...
                            else
                            {
                                ...
                                {
                                    case "right":
                                        textAnchorHorizontal.Value = TextAnchorHorizontalEnum.Right;
                                        break;
                                    case "center":
                                        textAnchorHorizontal.Value = TextAnchorHorizontalEnum.Center;
                                        break;
                                    case "left":
                                        textAnchorHorizontal.Value = TextAnchorHorizontalEnum.Left;
                                        break;
                                    default:
                                        throw new MapCSSDomainParserException(declarationTree,
                                            string.Format("{1} value {0} cannot be parsed!", valueString, qualifierString));
                        ...
                        case "text-wrap-width":
                            var textWrapWidth = new DeclarationInt();
                            textWrapWidth.Qualifier = DeclarationIntEnum.MaxWidth;
                            if (evalCall != null)
                            {
                                textWrapWidth.EvalFunction = evalCall;
                            }
                            else
                            {
                                if (int.TryParse(valueString, NumberStyles.Any, System.Globalization.CultureInfo.InvariantCulture, out valueInt))
                                {
                                    textWrapWidth.Value = valueInt;
                                }
                                else
                                { // value could not be parsed.
                                    throw new MapCSSDomainParserException(declarationTree,
                            ...
                            // add declaration.
                            rule.Declarations.Add(textWrapWidth);
                            break;
                        case "fill-opacity":
                        ...
                        case "image":
                            ...
                            break;
                        case "pattern-image":
                            var patternImage = new DeclarationURL();
                            patternImage.Qualifier = DeclarationURLEnum.PatternImage;
                            if (evalCall != null)
                            {
                                patternImage.EvalFunction = evalCall;
                            }
                            else
                            {
                                patternImage.Value = MapCSSDomainParser.ParseURL(valueString);
                            }

                            // add declaration.
                            rule.Declarations.Add(patternImage);
                            break;
                        case "z-index":
                        ...
                        case "font-family":
                            ...
                            break;
                        case "text-offset-y":
                            var textOffsetY = new DeclarationInt();
                            textOffsetY.Qualifier = DeclarationIntEnum.TextOffsetY;
                            if (evalCall != null)
                            {
                                textOffsetY.EvalFunction = evalCall;
                            }
                            else
                            {
                                if (int.TryParse(valueString, NumberStyles.Any, System.Globalization.CultureInfo.InvariantCulture, out valueInt))
                                {
                                    textOffsetY.Value = valueInt;
                                }
                                else
                                { // value could not be parsed.
                                    throw new MapCSSDomainParserException(declarationTree,
                            ...
                            // add declaration.
                            rule.Declarations.Add(textOffsetY);
                            break;
                        case "text-spacing":
                            var textSpacing = new DeclarationInt();
                            textSpacing.Qualifier = DeclarationIntEnum.TextSpacing;
                            if (evalCall != null)
                            {
                                textSpacing.EvalFunction = evalCall;
                            }
                            else
                            {
                                textSpacing.Value = MapCSSDomainParser.ParseColor(
                                    declarationTree.Children[1] as CommonTree);
                            }

                            // add declaration.
                            rule.Declarations.Add(textSpacing);
                            break;
                        case "text":
                        ...
                        case "text-wrap-character":
                            var textWrapCharacter = new DeclarationString();
                            textWrapCharacter.Qualifier = DeclarationStringEnum.TextWrapCharacter;
                            if (evalCall != null)
                            {
                                textWrapCharacter.EvalFunction = evalCall;
                            }
                            else
                            {
                                textWrapCharacter.Value = valueString;
                            }

                            // add declaration.
                            rule.Declarations.Add(textWrapCharacter);
                            break;
                        default:
