...
namespace Mapsui.VectorTiles.MapCSSStyler
{
    ...
    /// </summary>
    public class MapCSSInterpreter
    {
        /// <summary>
        ...
        /// </summary>
        /// <returns></returns>
        public SimpleColor GetCanvasColor()
        {
            if (_mapCSSFile != null && 
        ...
        //     /// <param name="feature">The osm object.</param>
        //     /// <returns></returns>
        //     public void Translate(Feature feature)
        //     {
        ...
        //                     feature.Tags.Count == 0)
        //                 { // this node can never be selected, no tags and no id selectors.
        //                     break;
        //                 }
        //                 if (!_mapCSSFile.HasNodeIdSelector &&
        //                     _keysForNodes != null &&
        //                     !feature.Tags.ContainsOneOfKeys(_keysForNodes))
        //                 { // no good keys present.
        //                     break;
        //                 }
        //                 this.TranslateNode(feature);
        //                 break;
        //             case GeometryType.LineString:
        //                 var relevantWayTags = feature.Tags;
        //                 if (_keysForWays != null)
        //                 { // filter the collection.
        //                     relevantWayTags = (TagsCollection)relevantWayTags.KeepKeysOf(_keysForWays);
        //                 }
        ...
        //                     if (feature.Geometry.First().Points.Count > 0 && !this.TranslateWay(feature, relevantWayTags))
        //                     { // ... but translate was unsuccesfull.
        //                         _unsuccesfullWays.Add(relevantWayTags);
        //                     }
        //                 }
        //                 break;
        //             case GeometryType.Relation:
        //                 if (!_mapCSSFile.HasRelationIdSelector &&
        //                     _keysForRelations != null &&
        //                     !feature.Tags.ContainsOneOfKeys(_keysForRelations))
        //                 { // no good keys present.
        //                     break;
        //                 }
        //                 this.TranslateRelation(feature);
        //                 break;
        //         }

        //         // interpret the osmGeo object and check if it makes up an area.
        //         if (feature.GeometryType != CompleteOsmType.Node)
        //         { // nodes cannot lead to a geometry for MapCSS.
        //             if (_keysForLines == null || feature.Tags.ContainsOneOfKeys(_keysForLines) ||
        //                 _keysForAreas == null || feature.Tags.ContainsOneOfKeys(_keysForAreas))
        //             { // good keys present.
        //                 var collection = _geometryInterpreter.Interpret(feature);
        ...
        //             if (feature.Type == CompleteOsmType.Node &&
        //                 _mapCSSFile != null &&
        //                 _mapCSSFile.DefaultPoints)
        //             { // apply default points style.
        //                 Node node = (feature as Node);
        ...
        //             }
        //             else if (feature.Type == CompleteOsmType.Way &&
        //                 _mapCSSFile != null &&
        //                 _mapCSSFile.DefaultLines)
        //             { // apply default lines style.
        //                 CompleteWay way = (feature as CompleteWay);
        //                 // get x/y.
        ...
        //         {
        //             if (!rule.TryGetProperty<int>("zIndex", out var zIndex))
        //             {
        //                 zIndex = 0;
        //             }
        ...
        //             uint? pointId = null;
        //             if (rule.TryGetProperty<int>("color", out var color))
        //             {
        //                 if (rule.TryGetProperty<float>("width", out var width))
        //                 {
        ...
        //         {
        //             this.TranslatePolygon(scene, projection, new Feature(polygon, multiPolygon.Tags));
        //         }
        //     }
        ...
        /// <returns></returns>
        public List<MapCSSRuleProperties> BuildRules(MapCSSObject mapCSSObject)
        {
                  ...
                  // loop over all declarations.
                    ...
                    foreach (var declaration in rule.Declarations)
                    {
                        if (declaration is DeclarationInt)
                        {
                            ...
                            switch (declarationInt.Qualifier)
                            {
                                ...
                                case DeclarationIntEnum.TextOffsetY:
                                    ...
                                    break;
                                case DeclarationIntEnum.TextSpacing:
                                    properties.AddProperty("textSpacing", declarationInt.Eval(mapCSSObject));
                                    break;
                                default:
                        ...
                        else if (declaration is DeclarationString)
                        {
                            ...
                            switch (declarationString.Qualifier)
                            {
                                ...
                                case DeclarationStringEnum.Text:
                                    ...
                                    break;
                                case DeclarationStringEnum.TextWrapCharacter:
                                    properties.AddProperty("textWrapCharacter", declarationString.Eval(mapCSSObject));
                                    break;
                                default:
                                    throw new ArgumentOutOfRangeException();
                            }
                        ...
                        else if (declaration is DeclarationURL)
                        {
                            ...
                            switch (declarationURL.Qualifier)
                            {
                                ...
                                case DeclarationURLEnum.ShieldImage:
                                    ...
                                    break;
                                case DeclarationURLEnum.PatternImage:
                                    if (_mapCSSImageSource.TryGet(declarationURL.Eval(mapCSSObject), out image))
                                    {
                                        properties.AddProperty("patternImage", image);
                                    }
                                    break;
                                default:
                                    throw new ArgumentOutOfRangeException();
                        ...
                        else if (declaration is DeclarationLineJoin)
                        {
                            ...
                            properties.AddProperty("lineJoin", declarationLineJoin.Eval(mapCSSObject));
                        }
                        else if (declaration is DeclarationDashes)
                        {
                            var declarationDashes = (declaration as DeclarationDashes);
                            properties.AddProperty("dashes", declarationDashes.Eval(mapCSSObject));
                        }
                        else if (declaration is DeclarationTextAnchorVertical)
                        {
                            var declarationTextAnchorVertical = (declaration as DeclarationTextAnchorVertical);
                            properties.AddProperty("textAnchorVertical", declarationTextAnchorVertical.Eval(mapCSSObject));
                        }
                        else if (declaration is DeclarationTextAnchorHorizontal)
                        {
                            var declarationTextAnchorHorizontal = (declaration as DeclarationTextAnchorHorizontal);
                            properties.AddProperty("textAnchorHorizontal", declarationTextAnchorHorizontal.Eval(mapCSSObject));
                        }
                    }
