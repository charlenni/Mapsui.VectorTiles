...
namespace Mapsui.VectorTiles
{
    ...
    /// </summary>
    public abstract class TagsCollectionBase : IEnumerable<Tag>, IEnumerable<KeyValuePair<string, JValue>>, ITagsSource
    {
        /// <summary>
        ...
        public abstract void Add(string key, JValue value);
        ...
        /// <param name="key"></param>
        /// <param name="value"></param>
        public abstract void AddOrReplace(string key, JValue value);
        ...
        /// <param name="value"></param>
        /// <returns></returns>
        public abstract bool TryGetValue(string key, out JValue value);
        ...
        /// <param name="value"></param>
        /// <returns></returns>
        public abstract bool ContainsKeyValue(string key, JValue value);
        ...
        /// <param name="value"></param>
        /// <returns></returns>
        public abstract bool RemoveKeyValue(string key, JValue value);
        ...
        public Dictionary<string, string> ToStringStringDictionary()
        {
            ...
            foreach (var tag in this)
            {
                dic[tag.Key] = tag.Value.ToString();
            }
            return dic;
        }
        ...
        /// </summary>
        /// <returns></returns>
        #region IEnumerable<KeyValuePair<string, JValue>>
        ...
        /// </summary>
        private class KeyValuePairEnumerator : IEnumerator<KeyValuePair<string, JValue>>
        {
            ...
            {
                get { return new KeyValuePair<string, JValue>(_tagEnumerator.Current.Key, _tagEnumerator.Current.Value); }
            }
