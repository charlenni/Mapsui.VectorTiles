...
namespace org.oscim.theme
{
	...
	using FastMath = org.oscim.utils.FastMath;
...
//	import static int.Parse;
	...
	public class XmlMapsforgeThemeBuilder : DefaultHandler
	{

		private static readonly Logger log = LoggerFactory.getLogger(typeof(XmlMapsforgeThemeBuilder));

		private const int RENDER_THEME_VERSION = 6;
		...
		private const string ELEMENT_NAME_MATCH = "rule";
		...
		private static readonly int DEFAULT_PRIORITY = int.MaxValue / 2;
...
//ORIGINAL LINE: private final org.oscim.theme.styles.TextStyle.TextBuilder<?> mTextBuilder = org.oscim.theme.styles.TextStyle.builder();
		...
		public XmlMapsforgeThemeBuilder(ThemeFile theme) : this(theme, null)
		{
		}
		...
		public override void endDocument()
		{
			...
			{
				rules[i] = mRulesList[i].onComplete(new int[1]);
			}
...
//ORIGINAL LINE: private void checkElement(String elementName, Element element) throws org.xml.sax.SAXException
		private void checkElement(string elementName, Element element)
		{
			...
			switch (element)
			{
				case org.oscim.theme.XmlMapsforgeThemeBuilder.Element.RENDER_THEME:
				...
				case org.oscim.theme.XmlMapsforgeThemeBuilder.Element.RULE:
				...
				case org.oscim.theme.XmlMapsforgeThemeBuilder.Element.STYLE:
					parentElement = mElementStack.Peek();
				...
				case org.oscim.theme.XmlMapsforgeThemeBuilder.Element.RENDERING_INSTRUCTION:
				...
				case org.oscim.theme.XmlMapsforgeThemeBuilder.Element.ATLAS:
					parentElement = mElementStack.Peek();
					// FIXME
				...
				case org.oscim.theme.XmlMapsforgeThemeBuilder.Element.RENDERING_STYLE:
					return;
			}
...
//ORIGINAL LINE: org.oscim.theme.styles.TextStyle.TextBuilder<?> b;
			...
			for (int i = 0; i < attributes.Length; i++)
			{
				...
				else if ("priority".Equals(name))
				{
					...
					b.priority = FastMath.clamp(DEFAULT_PRIORITY - b.priority, 0, int.MaxValue);
...
//ORIGINAL LINE: org.oscim.theme.styles.ExtrusionStyle.ExtrusionBuilder<?> b = mExtrusionBuilder.reset();
			...
			rule.element(Rule.Element.WAY).zoom((sbyte) 17, sbyte.MaxValue).style(b);
			return rule;
		}
	}
