...
namespace org.oscim.theme
{
	...
	public class XmlMapsforgeAtlasThemeBuilder : XmlMapsforgeThemeBuilder
	{
...
//ORIGINAL LINE: org.oscim.theme.styles.SymbolStyle.SymbolBuilder<?> symbolBuilder = org.oscim.theme.styles.SymbolStyle.builder();
		...
		public XmlMapsforgeAtlasThemeBuilder(ThemeFile theme, ThemeCallback themeCallback, IDictionary<object, TextureRegion> regionMap, IList<TextureAtlas> atlasList) : base(theme, themeCallback)
		{
